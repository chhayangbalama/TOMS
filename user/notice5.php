  ...
  <nav class="navbar navbar-expand-lg bg-light fixed-top">
    ...
    <div class="container main-body shadow my-3 py-4">
        <div class="col-md-12 col-sm-12 border-right">
            ...
            <h6>03/01/2025</h6>
            <hr>
            <img src="img/notic1.jpg" class="rounded mx-auto d-block" style="width: 700px;" alt="notice">
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-center pt-2" style="background-color: aliceblue;">
        ...
        <ul class="list-unstyled d-flex mb-4">
            ...
            <li class="ms-3"><a href="https://www.facebook.com/chhayangba.lama.5"><i class="bi bi-facebook"
                        width="100" height="100"></i><span class="visually-hidden">Facebook
                        group</span></a></li>
