...
<body>
    ...
    <div class="alert alert-primary justify-content-center text-center" role="alert">
        <b>Model Driving License Questions</b>
    </div>

    <iframe class="mb-2" src="img/exam.pdf" width="100%" height="800px"></iframe>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-center pt-2 fixed-bottom"
        ...
        <ul class="list-unstyled d-flex mb-4">
            <li class="ms-3">
                <a href="https://www.facebook.com/chhayangba.lama.5"><i class="bi bi-facebook"></i></a>
            </li>
