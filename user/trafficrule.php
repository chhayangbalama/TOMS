...
<body>
        ...
        <div class="ps-5 justify-content-center align-items-center container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ps-2">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="userdash.php">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="alert alert-primary justify-content-center text-center" role="alert">
        <b>Traffic Rules Of Nepal</b>
    </div>

    <iframe class="mb-2" src="img/trafficrule.pdf" width="100%" height="800px"></iframe>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-center pt-2 fixed-bottom"
        ...
        <ul class="list-unstyled d-flex mb-4">
            <li class="ms-3"><a href="https://www.facebook.com/chhayangba.lama.5"><i class="bi bi-facebook"></i><span class="visually-hidden">Facebook group</span></a></li>
