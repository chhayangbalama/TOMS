  ...
  <div class="container">
    ...
    <div class="content-2">
      <div class="recent-payments">
        <div class="title"><h2 class="text">User Details</h2></div>
        <table>
          <tr>
            <th>ID</th>
            <th>Full Name</th>
            ...
            if (mysqli_num_rows($result) > 0) {
              while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                        ...
                        <td>
                          <form method='post' action='del_user.php' onsubmit='return confirm(\"Are you sure you want to delete this user?\");'>
